    ...
    createUserWithEmailAndPassword(auth, email, password)
      .then(credential => {
        ...
        updateProfile(credential.user, {
          displayName: name,
          photoURL: `https://scontent.fcai21-4.fna.fbcdn.net/v/t1.30497-1/143086968_2856368904622192_1959732218791162458_n.png?_nc_cat=1&ccb=1-7&_nc_sid=7206a8&_nc_ohc=1Rph2yqJK04AX93nY3X&_nc_ht=scontent.fcai21-4.fna&oh=00_AT9bV_N5wYF1A1VhOmmyPq-a0psSTKWejeuiH3F5Ccdpew&oe=63787DF8`,
        }).then(() => {
